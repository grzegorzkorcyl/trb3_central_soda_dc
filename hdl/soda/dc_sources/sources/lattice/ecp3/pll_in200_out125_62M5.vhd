...
-- Module  Version: 5.3
--C:\lscc\diamond\2.1_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_in200_out125_62M5 -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 200 -phase_cntl STATIC -bypasss -fclkop 125 -fclkop_tol 0.0 -fb_mode CLOCKTREE -phaseadj 0.0 -duty 8 -fclkok 62.5 -fclkok_tol 0.0 -clkoki 0 -norst -noclkok2 -bw -e 
...
entity pll_in200_out125_62M5 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        CLKOS: out std_logic; 
 ...
 attribute dont_touch of pll_in200_out125_62M5 : entity is true;
end pll_in200_out125_62M5;

architecture Structure of pll_in200_out125_62M5 is
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_in200_out125_62M5 is
    for Structure
