...
entity pll_in200_out200M_100M is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        CLKOS: out std_logic; 
 ...
 attribute dont_touch of pll_in200_out200M_100M : entity is true;
end pll_in200_out200M_100M;

architecture Structure of pll_in200_out200M_100M is
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_in200_out200M_100M is
    for Structure
