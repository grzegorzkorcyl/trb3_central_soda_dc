...
GENERIC(
  ...
  PLL_SRC   : String
--  CONFIG_FILE : String  := "serdes_sync_125_full.txt";
...
entity serdes_sync_125_full is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_sync_125_full.txt");
 port (
------------------
-- CH0 --
...
end serdes_sync_125_full;


architecture serdes_sync_125_full_arch of serdes_sync_125_full is
