...
-- Module  Version: 5.7
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n async_fifo_nn_progfull1900_progempty128_2048x36_ecp3 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 2048 -width 36 -depth 2048 -rdata_width 36 -no_enable -pe 128 -pf 1900 -rfill 

-- Thu Sep 24 09:26:37 2015
...
entity async_fifo_nn_progfull1900_progempty128_2048x36_ecp3 is
    port (
...
end async_fifo_nn_progfull1900_progempty128_2048x36_ecp3;

architecture Structure of async_fifo_nn_progfull1900_progempty128_2048x36_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_3 : label is "async_fifo_nn_progfull1900_progempty128_2048x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_3 : label is "";
    attribute RESETMODE of pdp_ram_0_0_3 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_1_2 : label is "async_fifo_nn_progfull1900_progempty128_2048x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_2 : label is "";
    attribute RESETMODE of pdp_ram_0_1_2 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_2_1 : label is "async_fifo_nn_progfull1900_progempty128_2048x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_2_1 : label is "";
    attribute RESETMODE of pdp_ram_0_2_1 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_3_0 : label is "async_fifo_nn_progfull1900_progempty128_2048x36_ecp3.lpc";
...
begin
    ...
    XOR2_t0: XOR2
        port map (A=>w_gcount_r211, B=>rptr_11, Z=>rfill_sub_msb);
    ...
    pdp_ram_0_3_0: DP16KC
        ...
        port map (DIA0=>Data(27), DIA1=>Data(28), DIA2=>Data(29), 
            ...
            DOB5=>Q(32), DOB6=>Q(33), DOB7=>Q(34), DOB8=>Q(35), 
            DOB9=>open, DOB10=>open, DOB11=>open, DOB12=>open, 
            DOB13=>open, DOB14=>open, DOB15=>open, DOB16=>open, 
            DOB17=>open);
    ...
    rfill_4: FSUB2B
        port map (A0=>wcount_r7, A1=>w_g2b_xor_cluster_0, B0=>rptr_7, 
    ...
    rfill_6: FSUB2B
        port map (A0=>rfill_sub_msb, A1=>scuba_vlo, B0=>scuba_vlo, 
            B1=>scuba_vlo, BI=>co5_2, BOUT=>open, S0=>rfill_sub_11, 
            S1=>open);
    ...
    ae_set_ctr_5: CU2
        port map (CI=>co4_5, PC0=>ae_setcount_10, PC1=>ae_setcount_11, 
            CO=>co5_3, NC0=>iae_setcount_10, NC1=>iae_setcount_11);
    ...
    ae_set_cmp_3: AGEB2
        port map (A0=>ae_setcount_6, A1=>ae_setcount_7, B0=>wcount_r6, 
            B1=>wcount_r7, CI=>co2_6, GE=>co3_6);

    ae_set_cmp_4: AGEB2
        port map (A0=>ae_setcount_8, A1=>ae_setcount_9, 
            B0=>w_g2b_xor_cluster_0, B1=>wcount_r9, CI=>co3_6, GE=>co4_6);

    ae_set_cmp_5: AGEB2
        port map (A0=>ae_setcount_10, A1=>ae_set_cmp_set, B0=>wcount_r10, 
            B1=>ae_set_cmp_clr, CI=>co4_6, GE=>ae_set_d_c);
    ...
    af_set_ctr_5: CU2
        port map (CI=>co4_7, PC0=>af_setcount_10, PC1=>af_setcount_11, 
    ...
    af_set_cmp_5: AGEB2
        port map (A0=>af_setcount_10, A1=>af_set_cmp_set, B0=>rcount_w10, 
            B1=>af_set_cmp_clr, CI=>co4_8, GE=>af_set_c);
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_nn_progfull1900_progempty128_2048x36_ecp3 is
    for Structure
