...
-- Module  Version: 5.7
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 1024 -width 99 -depth 1024 -rdata_width 99 -no_enable -pe 128 -pf 512 -rfill 
...
entity async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3 is
    port (
...
end async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3;

architecture Structure of async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_5 : label is "async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_5 : label is "";
    attribute RESETMODE of pdp_ram_0_0_5 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_1_4 : label is "async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_4 : label is "";
    attribute RESETMODE of pdp_ram_0_1_4 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_2_3 : label is "async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_2_3 : label is "";
    attribute RESETMODE of pdp_ram_0_2_3 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_3_2 : label is "async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_3_2 : label is "";
    attribute RESETMODE of pdp_ram_0_3_2 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_4_1 : label is "async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_4_1 : label is "";
    attribute RESETMODE of pdp_ram_0_4_1 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_5_0 : label is "async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_5_0 : label is "";
    attribute RESETMODE of pdp_ram_0_5_0 : label is "SYNC";
...
begin
    ...
    LUT4_3: ROM16X1A
        ...
        port map (AD3=>ae_setcount_10, AD2=>rcount_10, 
            AD1=>w_gcount_r210, AD0=>rptr_10, DO0=>ae_set_cmp_set);

    LUT4_2: ROM16X1A
        generic map (initval=> X"2004")
        port map (AD3=>ae_setcount_10, AD2=>rcount_10, 
            AD1=>w_gcount_r210, AD0=>rptr_10, DO0=>ae_set_cmp_clr);

    LUT4_1: ROM16X1A
        generic map (initval=> X"4c32")
        port map (AD3=>af_setcount_10, AD2=>wcount_10, 
            AD1=>r_gcount_w210, AD0=>wptr_10, DO0=>af_set_cmp_set);

    LUT4_0: ROM16X1A
        generic map (initval=> X"8001")
        port map (AD3=>af_setcount_10, AD2=>wcount_10, 
            AD1=>r_gcount_w210, AD0=>wptr_10, DO0=>af_set_cmp_clr);

    pdp_ram_0_0_5: DP16KC
    ...
    pdp_ram_0_2_3: DP16KC
        ...
        port map (DIA0=>Data(36), DIA1=>Data(37), DIA2=>Data(38), 
            ...
            DOA6=>open, DOA7=>open, DOA8=>open, DOA9=>open, DOA10=>open, 
            DOA11=>open, DOA12=>open, DOA13=>open, DOA14=>open, 
            DOA15=>open, DOA16=>open, DOA17=>open, DOB0=>Q(36), 
            DOB1=>Q(37), DOB2=>Q(38), DOB3=>Q(39), DOB4=>Q(40), 
            DOB5=>Q(41), DOB6=>Q(42), DOB7=>Q(43), DOB8=>Q(44), 
            DOB9=>Q(45), DOB10=>Q(46), DOB11=>Q(47), DOB12=>Q(48), 
            DOB13=>Q(49), DOB14=>Q(50), DOB15=>Q(51), DOB16=>Q(52), 
            DOB17=>Q(53));

    pdp_ram_0_3_2: DP16KC
        generic map (CSDECODE_B=> "0b000", CSDECODE_A=> "0b000", 
        WRITEMODE_B=> "NORMAL", WRITEMODE_A=> "NORMAL", GSR=> "DISABLED", 
        REGMODE_B=> "NOREG", REGMODE_A=> "NOREG", DATA_WIDTH_B=>  18, 
        DATA_WIDTH_A=>  18)
        port map (DIA0=>Data(54), DIA1=>Data(55), DIA2=>Data(56), 
            ...
            DOA6=>open, DOA7=>open, DOA8=>open, DOA9=>open, DOA10=>open, 
            DOA11=>open, DOA12=>open, DOA13=>open, DOA14=>open, 
            DOA15=>open, DOA16=>open, DOA17=>open, DOB0=>Q(54), 
            DOB1=>Q(55), DOB2=>Q(56), DOB3=>Q(57), DOB4=>Q(58), 
            DOB5=>Q(59), DOB6=>Q(60), DOB7=>Q(61), DOB8=>Q(62), 
            DOB9=>Q(63), DOB10=>Q(64), DOB11=>Q(65), DOB12=>Q(66), 
            DOB13=>Q(67), DOB14=>Q(68), DOB15=>Q(69), DOB16=>Q(70), 
            DOB17=>Q(71));

    pdp_ram_0_4_1: DP16KC
        generic map (CSDECODE_B=> "0b000", CSDECODE_A=> "0b000", 
        WRITEMODE_B=> "NORMAL", WRITEMODE_A=> "NORMAL", GSR=> "DISABLED", 
        REGMODE_B=> "NOREG", REGMODE_A=> "NOREG", DATA_WIDTH_B=>  18, 
        DATA_WIDTH_A=>  18)
        port map (DIA0=>Data(72), DIA1=>Data(73), DIA2=>Data(74), 
            ...
            DIA9=>Data(81), DIA10=>Data(82), DIA11=>Data(83), 
            DIA12=>Data(84), DIA13=>Data(85), DIA14=>Data(86), 
            DIA15=>Data(87), DIA16=>Data(88), DIA17=>Data(89), 
            ADA0=>scuba_vhi, ADA1=>scuba_vhi, ADA2=>scuba_vlo, 
            ADA3=>scuba_vlo, ADA4=>wptr_0, ADA5=>wptr_1, ADA6=>wptr_2, 
            ADA7=>wptr_3, ADA8=>wptr_4, ADA9=>wptr_5, ADA10=>wptr_6, 
            ADA11=>wptr_7, ADA12=>wptr_8, ADA13=>wptr_9, CEA=>wren_i, 
            ...
            DOA6=>open, DOA7=>open, DOA8=>open, DOA9=>open, DOA10=>open, 
            DOA11=>open, DOA12=>open, DOA13=>open, DOA14=>open, 
            DOA15=>open, DOA16=>open, DOA17=>open, DOB0=>Q(72), 
            DOB1=>Q(73), DOB2=>Q(74), DOB3=>Q(75), DOB4=>Q(76), 
            DOB5=>Q(77), DOB6=>Q(78), DOB7=>Q(79), DOB8=>Q(80), 
            DOB9=>Q(81), DOB10=>Q(82), DOB11=>Q(83), DOB12=>Q(84), 
            DOB13=>Q(85), DOB14=>Q(86), DOB15=>Q(87), DOB16=>Q(88), 
            DOB17=>Q(89));

    pdp_ram_0_5_0: DP16KC
        generic map (CSDECODE_B=> "0b000", CSDECODE_A=> "0b000", 
        WRITEMODE_B=> "NORMAL", WRITEMODE_A=> "NORMAL", GSR=> "DISABLED", 
        REGMODE_B=> "NOREG", REGMODE_A=> "NOREG", DATA_WIDTH_B=>  18, 
        DATA_WIDTH_A=>  18)
        port map (DIA0=>Data(90), DIA1=>Data(91), DIA2=>Data(92), 
            ...
            DOA6=>open, DOA7=>open, DOA8=>open, DOA9=>open, DOA10=>open, 
            DOA11=>open, DOA12=>open, DOA13=>open, DOA14=>open, 
            DOA15=>open, DOA16=>open, DOA17=>open, DOB0=>Q(90), 
            DOB1=>Q(91), DOB2=>Q(92), DOB3=>Q(93), DOB4=>Q(94), 
            DOB5=>Q(95), DOB6=>Q(96), DOB7=>Q(97), DOB8=>Q(98), 
    ...
    FF_16: FD1P3BX
        port map (D=>iae_setcount_7, SP=>rden_i, CK=>RdClock, PD=>rRst, 
            Q=>ae_setcount_7);
    ...
    rfill_0: FSUB2B
        port map (A0=>scuba_vhi, A1=>wcount_r0, B0=>scuba_vlo, 
            B1=>rptr_0, BI=>precin, BOUT=>co0_2, S0=>open, 
            S1=>rfill_sub_0);
    ...
    rfill_4: FSUB2B
        port map (A0=>w_g2b_xor_cluster_0, A1=>wcount_r8, B0=>rptr_7, 
            B1=>rptr_8, BI=>co3_2, BOUT=>co4_2, S0=>rfill_sub_7, 
            S1=>rfill_sub_8);

    rfill_5: FSUB2B
        port map (A0=>wcount_r9, A1=>rfill_sub_msb, B0=>rptr_9, 
            B1=>scuba_vlo, BI=>co4_2, BOUT=>co5_2, S0=>rfill_sub_9, 
            S1=>rfill_sub_10);
    ...
    full_cmp_5: AGEB2
        port map (A0=>full_cmp_set, A1=>scuba_vlo, B0=>full_cmp_clr, 
            B1=>scuba_vlo, CI=>co4_4, GE=>full_d_c);
    ...
    ae_set_ctr_0: CU2
        port map (CI=>ae_set_ctr_ci, PC0=>ae_setcount_0, 
            PC1=>ae_setcount_1, CO=>co0_5, NC0=>iae_setcount_0, 
            NC1=>iae_setcount_1);

    ae_set_ctr_1: CU2
        port map (CI=>co0_5, PC0=>ae_setcount_2, PC1=>ae_setcount_3, 
            CO=>co1_5, NC0=>iae_setcount_2, NC1=>iae_setcount_3);

    ae_set_ctr_2: CU2
        port map (CI=>co1_5, PC0=>ae_setcount_4, PC1=>ae_setcount_5, 
            CO=>co2_5, NC0=>iae_setcount_4, NC1=>iae_setcount_5);

    ae_set_ctr_3: CU2
        port map (CI=>co2_5, PC0=>ae_setcount_6, PC1=>ae_setcount_7, 
            CO=>co3_5, NC0=>iae_setcount_6, NC1=>iae_setcount_7);

    ae_set_ctr_4: CU2
        port map (CI=>co3_5, PC0=>ae_setcount_8, PC1=>ae_setcount_9, 
            CO=>co4_5, NC0=>iae_setcount_8, NC1=>iae_setcount_9);

    ae_set_ctr_5: CU2
        port map (CI=>co4_5, PC0=>ae_setcount_10, PC1=>scuba_vlo, 
            CO=>co5_3, NC0=>iae_setcount_10, NC1=>open);
    ...
    ae_set_cmp_0: AGEB2
        port map (A0=>ae_setcount_0, A1=>ae_setcount_1, B0=>wcount_r0, 
            B1=>wcount_r1, CI=>cmp_ci_2, GE=>co0_6);

    ae_set_cmp_1: AGEB2
        port map (A0=>ae_setcount_2, A1=>ae_setcount_3, B0=>wcount_r2, 
            B1=>wcount_r3, CI=>co0_6, GE=>co1_6);

    ae_set_cmp_2: AGEB2
        port map (A0=>ae_setcount_4, A1=>ae_setcount_5, B0=>wcount_r4, 
            B1=>wcount_r5, CI=>co1_6, GE=>co2_6);

    ae_set_cmp_3: AGEB2
        port map (A0=>ae_setcount_6, A1=>ae_setcount_7, B0=>wcount_r6, 
            B1=>w_g2b_xor_cluster_0, CI=>co2_6, GE=>co3_6);

    ae_set_cmp_4: AGEB2
        port map (A0=>ae_setcount_8, A1=>ae_setcount_9, B0=>wcount_r8, 
            B1=>wcount_r9, CI=>co3_6, GE=>co4_6);

    ae_set_cmp_5: AGEB2
        port map (A0=>ae_set_cmp_set, A1=>scuba_vlo, B0=>ae_set_cmp_clr, 
            B1=>scuba_vlo, CI=>co4_6, GE=>ae_set_d_c);
    ...
    af_set_ctr_0: CU2
        port map (CI=>af_set_ctr_ci, PC0=>af_setcount_0, 
            PC1=>af_setcount_1, CO=>co0_7, NC0=>iaf_setcount_0, 
            NC1=>iaf_setcount_1);

    af_set_ctr_1: CU2
        port map (CI=>co0_7, PC0=>af_setcount_2, PC1=>af_setcount_3, 
            CO=>co1_7, NC0=>iaf_setcount_2, NC1=>iaf_setcount_3);

    af_set_ctr_2: CU2
        port map (CI=>co1_7, PC0=>af_setcount_4, PC1=>af_setcount_5, 
            CO=>co2_7, NC0=>iaf_setcount_4, NC1=>iaf_setcount_5);

    af_set_ctr_3: CU2
        port map (CI=>co2_7, PC0=>af_setcount_6, PC1=>af_setcount_7, 
            CO=>co3_7, NC0=>iaf_setcount_6, NC1=>iaf_setcount_7);

    af_set_ctr_4: CU2
        port map (CI=>co3_7, PC0=>af_setcount_8, PC1=>af_setcount_9, 
            CO=>co4_7, NC0=>iaf_setcount_8, NC1=>iaf_setcount_9);

    af_set_ctr_5: CU2
        port map (CI=>co4_7, PC0=>af_setcount_10, PC1=>scuba_vlo, 
            CO=>co5_4, NC0=>iaf_setcount_10, NC1=>open);
    ...
    af_set_cmp_3: AGEB2
        port map (A0=>af_setcount_6, A1=>af_setcount_7, B0=>rcount_w6, 
            B1=>r_g2b_xor_cluster_0, CI=>co2_8, GE=>co3_8);
    ...
    af_set_cmp_5: AGEB2
        port map (A0=>af_set_cmp_set, A1=>scuba_vlo, B0=>af_set_cmp_clr, 
            B1=>scuba_vlo, CI=>co4_8, GE=>af_set_c);
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_nn_progfull512_progempty128_FWFT_1024x99_ecp3 is
    for Structure
