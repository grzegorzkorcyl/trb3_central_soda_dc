...
entity pll_in200_out160M_80M is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        CLKOK: out std_logic; 
 ...
 attribute dont_touch of pll_in200_out160M_80M : entity is true;
end pll_in200_out160M_80M;

architecture Structure of pll_in200_out160M_80M is
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  4, CLKFB_DIV=>  4, CLKI_DIV=>  5, 
        FIN=> "200.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_in200_out160M_80M is
    for Structure
