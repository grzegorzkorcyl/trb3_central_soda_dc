...
-- Module  Version: 5.7
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n async_fifo_nn_thfull_512x36_ecp3 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 512 -width 36 -depth 512 -rdata_width 36 -no_enable -pe -1 -pf 378 -rfill 
...
entity async_fifo_nn_thfull_512x36_ecp3 is
    port (
...
end async_fifo_nn_thfull_512x36_ecp3;

architecture Structure of async_fifo_nn_thfull_512x36_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "async_fifo_nn_thfull_512x36_ecp3.lpc";
...
begin
    ...
    af_set_cmp_3: AGEB2
        port map (A0=>af_setcount_6, A1=>af_setcount_7, 
            B0=>r_g2b_xor_cluster_0, B1=>rcount_w7, CI=>co2_6, GE=>co3_6);

    af_set_cmp_4: AGEB2
        port map (A0=>af_setcount_8, A1=>af_set_cmp_set, B0=>rcount_w8, 
            B1=>af_set_cmp_clr, CI=>co3_6, GE=>af_set_c);
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_nn_thfull_512x36_ecp3 is
    for Structure
