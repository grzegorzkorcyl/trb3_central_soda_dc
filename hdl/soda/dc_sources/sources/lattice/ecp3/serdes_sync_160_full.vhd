...
GENERIC(
  ...
  PLL_SRC   : String
--  CONFIG_FILE : String  := "serdes_sync_160_full.txt";
...
entity serdes_sync_160_full is
   GENERIC (USER_CONFIG_FILE    :  String := "serdes_sync_160_full.txt");
 port (
------------------
-- CH0 --
...
end serdes_sync_160_full;


architecture serdes_sync_160_full_arch of serdes_sync_160_full is
...
port (
  ...
  REFCLK_TO_NQ          : out std_logic
   ...
   attribute FREQUENCY_PIN_FF_RX_F_CLK_0 of PCSD_INST : label is "160.000";
   attribute FREQUENCY_PIN_FF_RX_F_CLK_1: string;
   attribute FREQUENCY_PIN_FF_RX_F_CLK_1 of PCSD_INST : label is "160.000";
   attribute FREQUENCY_PIN_FF_RX_F_CLK_2: string;
   attribute FREQUENCY_PIN_FF_RX_F_CLK_2 of PCSD_INST : label is "160.000";
   attribute FREQUENCY_PIN_FF_RX_F_CLK_3: string;
   attribute FREQUENCY_PIN_FF_RX_F_CLK_3 of PCSD_INST : label is "160.000";
   attribute FREQUENCY_PIN_FF_RX_H_CLK_0: string;
   attribute FREQUENCY_PIN_FF_RX_H_CLK_0 of PCSD_INST : label is "80.0000";
   attribute FREQUENCY_PIN_FF_RX_H_CLK_1: string;
   attribute FREQUENCY_PIN_FF_RX_H_CLK_1 of PCSD_INST : label is "80.0000";
   attribute FREQUENCY_PIN_FF_RX_H_CLK_2: string;
   attribute FREQUENCY_PIN_FF_RX_H_CLK_2 of PCSD_INST : label is "80.0000";
   attribute FREQUENCY_PIN_FF_RX_H_CLK_3: string;
   attribute FREQUENCY_PIN_FF_RX_H_CLK_3 of PCSD_INST : label is "80.0000";
   attribute FREQUENCY_PIN_FF_TX_F_CLK_0: string;
   attribute FREQUENCY_PIN_FF_TX_F_CLK_0 of PCSD_INST : label is "160.000";
   attribute FREQUENCY_PIN_FF_TX_F_CLK_1: string;
   attribute FREQUENCY_PIN_FF_TX_F_CLK_1 of PCSD_INST : label is "160.000";
   attribute FREQUENCY_PIN_FF_TX_F_CLK_2: string;
   attribute FREQUENCY_PIN_FF_TX_F_CLK_2 of PCSD_INST : label is "160.000";
   attribute FREQUENCY_PIN_FF_TX_F_CLK_3: string;
   attribute FREQUENCY_PIN_FF_TX_F_CLK_3 of PCSD_INST : label is "160.000";
   attribute FREQUENCY_PIN_FF_TX_H_CLK_0: string;
   attribute FREQUENCY_PIN_FF_TX_H_CLK_0 of PCSD_INST : label is "80.0000";
   attribute FREQUENCY_PIN_FF_TX_H_CLK_1: string;
   attribute FREQUENCY_PIN_FF_TX_H_CLK_1 of PCSD_INST : label is "80.0000";
   attribute FREQUENCY_PIN_FF_TX_H_CLK_2: string;
   attribute FREQUENCY_PIN_FF_TX_H_CLK_2 of PCSD_INST : label is "80.0000";
   attribute FREQUENCY_PIN_FF_TX_H_CLK_3: string;
   attribute FREQUENCY_PIN_FF_TX_H_CLK_3 of PCSD_INST : label is "80.0000";
