...
-- Module  Version: 5.7
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n async_fifo_256x66_ecp3 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 256 -width 66 -depth 256 -rdata_width 66 -no_enable -pe -1 -pf -1 
...
entity async_fifo_256x66_ecp3 is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end async_fifo_256x66_ecp3;

architecture Structure of async_fifo_256x66_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_1 : label is "async_fifo_256x66_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_1 : label is "";
    attribute RESETMODE of pdp_ram_0_0_1 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_1_0 : label is "async_fifo_256x66_ecp3.lpc";
...
begin
    ...
    pdp_ram_0_1_0: PDPW16KC
        ...
        port map (DI0=>Data(36), DI1=>Data(37), DI2=>Data(38), 
            ...
            DI29=>Data(65), DI30=>scuba_vlo, DI31=>scuba_vlo, 
            ...
            DO9=>Q(63), DO10=>Q(64), DO11=>Q(65), DO12=>open, DO13=>open, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_256x66_ecp3 is
    for Structure
