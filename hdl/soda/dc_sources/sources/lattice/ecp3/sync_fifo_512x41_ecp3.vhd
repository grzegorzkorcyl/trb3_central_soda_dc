...
-- Module  Version: 5.0
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n sync_fifo_512x41_ecp3 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 512 -width 41 -depth 512 -no_enable -pe -1 -pf -1 
...
entity sync_fifo_512x41_ecp3 is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end sync_fifo_512x41_ecp3;

architecture Structure of sync_fifo_512x41_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_1 : label is "sync_fifo_512x41_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_1 : label is "";
    attribute RESETMODE of pdp_ram_0_0_1 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_1_0 : label is "sync_fifo_512x41_ecp3.lpc";
...
begin
    ...
    pdp_ram_0_1_0: PDPW16KC
        ...
        port map (DI0=>Data(36), DI1=>Data(37), DI2=>Data(38), 
            DI3=>Data(39), DI4=>Data(40), DI5=>scuba_vlo, DI6=>scuba_vlo, 
            ...
            DI34=>scuba_vlo, DI35=>scuba_vlo, ADW0=>wcount_0, 
            ADW1=>wcount_1, ADW2=>wcount_2, ADW3=>wcount_3, 
            ADW4=>wcount_4, ADW5=>wcount_5, ADW6=>wcount_6, 
            ADW7=>wcount_7, ADW8=>wcount_8, BE0=>scuba_vhi, 
            ...
            DO22=>Q(40), DO23=>open, DO24=>open, DO25=>open, DO26=>open, 
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of sync_fifo_512x41_ecp3 is
    for Structure
