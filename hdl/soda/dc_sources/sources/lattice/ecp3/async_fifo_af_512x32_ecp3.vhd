...
-- Module  Version: 5.4
--C:\lscc\diamond\2.1_x64\ispfpga\bin\nt64\scuba.exe -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 512 -width 32 -depth 512 -rdata_width 32 -no_enable -pe -1 -pf 508 -e 

-- Fri Jul 12 15:15:48 2013
...
entity async_fifo_af_512x32_ecp3 is
    port (
...
end async_fifo_af_512x32_ecp3;

architecture Structure of async_fifo_af_512x32_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "async_fifo_af_512x32_ecp3.lpc";
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_af_512x32_ecp3 is
    for Structure
