...
-- Module  Version: 5.4
--C:\lscc\diamond\2.1_x64\ispfpga\bin\nt64\scuba.exe -w -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 512 -width 36 -depth 512 -rdata_width 36 -no_enable -pe -1 -pf 503 -e 
...
entity async_fifo_af_512x36_ecp3 is
    port (
...
end async_fifo_af_512x36_ecp3;

architecture Structure of async_fifo_af_512x36_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "async_fifo_af_512x36_ecp3.lpc";
...
begin
    ...
    af_set_ctr_4: CU2
        port map (CI=>co3_4, PC0=>af_setcount_8, PC1=>af_setcount_9, 
            CO=>co4_2, NC0=>iaf_setcount_8, NC1=>iaf_setcount_9);
    ...
    af_set_cmp_3: AGEB2
        port map (A0=>af_setcount_6, A1=>af_setcount_7, 
            B0=>r_g2b_xor_cluster_0, B1=>rcount_w7, CI=>co2_5, GE=>co3_5);

    af_set_cmp_4: AGEB2
        port map (A0=>af_setcount_8, A1=>af_set_cmp_set, B0=>rcount_w8, 
            B1=>af_set_cmp_clr, CI=>co3_5, GE=>af_set_c);
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_af_512x36_ecp3 is
    for Structure
