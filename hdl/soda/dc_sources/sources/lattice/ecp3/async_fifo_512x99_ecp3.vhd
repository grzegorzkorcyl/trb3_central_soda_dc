...
-- Module  Version: 5.7
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n async_fifo_512x99_ecp3 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 512 -width 99 -depth 512 -rdata_width 99 -no_enable -pe -1 -pf -1 

-- Mon Oct 27 14:17:32 2014
...
entity async_fifo_512x99_ecp3 is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end async_fifo_512x99_ecp3;

architecture Structure of async_fifo_512x99_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_2 : label is "async_fifo_512x99_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_2 : label is "";
    attribute RESETMODE of pdp_ram_0_0_2 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_1_1 : label is "async_fifo_512x99_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_1 : label is "";
    attribute RESETMODE of pdp_ram_0_1_1 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_2_0 : label is "async_fifo_512x99_ecp3.lpc";
...
begin
    ...
    pdp_ram_0_2_0: PDPW16KC
        ...
        port map (DI0=>Data(72), DI1=>Data(73), DI2=>Data(74), 
            ...
            DI23=>Data(95), DI24=>Data(96), DI25=>Data(97), 
            DI26=>Data(98), DI27=>scuba_vlo, DI28=>scuba_vlo, 
            ...
            ADR11=>rptr_6, ADR12=>rptr_7, ADR13=>rptr_8, CER=>rden_i, 
            CLKR=>RdClock, CSR0=>scuba_vlo, CSR1=>scuba_vlo, 
            CSR2=>scuba_vlo, RST=>Reset, DO0=>Q(90), DO1=>Q(91), 
            DO2=>Q(92), DO3=>Q(93), DO4=>Q(94), DO5=>Q(95), DO6=>Q(96), 
            DO7=>Q(97), DO8=>Q(98), DO9=>open, DO10=>open, DO11=>open, 
            DO12=>open, DO13=>open, DO14=>open, DO15=>open, DO16=>open, 
            DO17=>open, DO18=>Q(72), DO19=>Q(73), DO20=>Q(74), 
            DO21=>Q(75), DO22=>Q(76), DO23=>Q(77), DO24=>Q(78), 
            DO25=>Q(79), DO26=>Q(80), DO27=>Q(81), DO28=>Q(82), 
            DO29=>Q(83), DO30=>Q(84), DO31=>Q(85), DO32=>Q(86), 
            DO33=>Q(87), DO34=>Q(88), DO35=>Q(89));
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_512x99_ecp3 is
    for Structure
