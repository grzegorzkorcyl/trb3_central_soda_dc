...
-- Module  Version: 5.7
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n async_fifo_nn_4096x36_ecp3 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 4096 -width 36 -depth 4096 -rdata_width 36 -no_enable -pe -1 -pf -1 -fill 

-- Thu Sep 18 10:10:35 2014
...
entity async_fifo_nn_4096x36_ecp3 is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end async_fifo_nn_4096x36_ecp3;

architecture Structure of async_fifo_nn_4096x36_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_7 : label is "async_fifo_nn_4096x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_0_7 : label is "";
    attribute RESETMODE of pdp_ram_0_0_7 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_1_6 : label is "async_fifo_nn_4096x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_1_6 : label is "";
    attribute RESETMODE of pdp_ram_0_1_6 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_2_5 : label is "async_fifo_nn_4096x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_2_5 : label is "";
    attribute RESETMODE of pdp_ram_0_2_5 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_0_3_4 : label is "async_fifo_nn_4096x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_0_3_4 : label is "";
    attribute RESETMODE of pdp_ram_0_3_4 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_1_0_3 : label is "async_fifo_nn_4096x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_1_0_3 : label is "";
    attribute RESETMODE of pdp_ram_1_0_3 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_1_1_2 : label is "async_fifo_nn_4096x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_1_1_2 : label is "";
    attribute RESETMODE of pdp_ram_1_1_2 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_1_2_1 : label is "async_fifo_nn_4096x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_1_2_1 : label is "";
    attribute RESETMODE of pdp_ram_1_2_1 : label is "SYNC";
    attribute MEM_LPC_FILE of pdp_ram_1_3_0 : label is "async_fifo_nn_4096x36_ecp3.lpc";
    attribute MEM_INIT_FILE of pdp_ram_1_3_0 : label is "";
    attribute RESETMODE of pdp_ram_1_3_0 : label is "SYNC";
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_nn_4096x36_ecp3 is
    for Structure
