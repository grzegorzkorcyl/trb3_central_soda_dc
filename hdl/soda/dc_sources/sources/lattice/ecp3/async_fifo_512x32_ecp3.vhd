...
-- Module  Version: 5.7
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n async_fifo_512x32_ecp3 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 512 -width 32 -depth 512 -rdata_width 32 -no_enable -pe -1 -pf -1 
...
entity async_fifo_512x32_ecp3 is
    port (
        ...
        Empty: out  std_logic; 
        Full: out  std_logic);
end async_fifo_512x32_ecp3;

architecture Structure of async_fifo_512x32_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "async_fifo_512x32_ecp3.lpc";
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_512x32_ecp3 is
    for Structure
