...
-- Module  Version: 5.7
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n async_fifo_nn_th_512x36_ecp3 -lang vhdl -synth synplify -bus_exp 7 -bb -arch ep5c00 -type ebfifo -depth 512 -width 36 -depth 512 -rdata_width 36 -no_enable -pe 128 -pf -1 -rfill 
...
entity async_fifo_nn_th_512x36_ecp3 is
    port (
...
end async_fifo_nn_th_512x36_ecp3;

architecture Structure of async_fifo_nn_th_512x36_ecp3 is
    ...
    attribute MEM_LPC_FILE of pdp_ram_0_0_0 : label is "async_fifo_nn_th_512x36_ecp3.lpc";
...
begin
    ...
    full_cmp_4: AGEB2
        port map (A0=>wcount_8, A1=>full_cmp_set, B0=>rcount_w8, 
            B1=>full_cmp_clr, CI=>co3_4, GE=>full_d_c);
    ...
    ae_set_cmp_3: AGEB2
        port map (A0=>ae_setcount_6, A1=>ae_setcount_7, 
            B0=>w_g2b_xor_cluster_0, B1=>wcount_r7, CI=>co2_6, GE=>co3_6);

    ae_set_cmp_4: AGEB2
        port map (A0=>ae_setcount_8, A1=>ae_set_cmp_set, B0=>wcount_r8, 
            B1=>ae_set_cmp_clr, CI=>co3_6, GE=>ae_set_d_c);
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of async_fifo_nn_th_512x36_ecp3 is
    for Structure
