...
-- Module  Version: 5.6
--C:\Lattice\diamond\3.2_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_in100_out80M -lang vhdl -synth synplify -arch ep5c00 -type pll -fin 100 -phase_cntl STATIC -fclkop 160 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -fclkok 80 -fclkok_tol 0.0 -clkoki 0 -norst -bw 
...
entity pll_in100_out80M is
 ...
 attribute dont_touch of pll_in100_out80M : entity is true;
end pll_in100_out80M;

architecture Structure of pll_in100_out80M is
    ...
    attribute FREQUENCY_PIN_CLKOK2 of PLLInst_0 : label is "53.333333";
    ...
    attribute FREQUENCY_PIN_CLKOK of PLLInst_0 : label is "80.000000";
...
begin
    ...
    PLLInst_0: EHXPLLF
        ...
        CLKOK_DIV=>  2, CLKOP_DIV=>  4, CLKFB_DIV=>  8, CLKI_DIV=>  5, 
        FIN=> "100.000000")
...
-- synopsys translate_off
library ecp3;
configuration Structure_CON of pll_in100_out80M is
    for Structure
